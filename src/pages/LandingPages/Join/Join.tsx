...
const Join = () => {
  return (
    <div className=" h-[350px]  mobile:h-[500px] flex items-center justify-center mb-[70px]">
      <div className="bg-[#EFF1FF] w-[85%] h-[100%] rounded-[10px] flex items-center justify-evenly flex-wrap mobile:justify-center mobile:h-[95%]">
    <Zoom>

        <div className=" w-[40%] h-[90%] mobile:h-fit flex gap-[30px] justify-center flex-col mobile:w-[90%] ">
        ...
        <div className=" w-[40%] h-[100%] mobile:h-fit flex items-end justify-center mobile:w-[90%]">
          <img
            className="h-[90%]"
