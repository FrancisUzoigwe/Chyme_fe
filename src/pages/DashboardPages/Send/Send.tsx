...
const Send = () => {
  ...
  return (
    <div className="w-[82%] bg-white absolute  right-0 h-[100%] rounded-tl-[30px] md:rounded-tl-none sm:rounded-tl-none rounded-bl-[30px] md:rounded-bl-none sm:rounded-bl-none p-[20px] md:p-0 sm:p-0 sm:w-[100%] md:w-[100%] sm:bg-[red] ">
      <div>
        <MobileSideBar />
      </div>
        ...
        <div className="w-[50%] max-md:w-[90%] min-h-[40%] flex flex-col items-center border py-2 rounded-md">
          <div className="w-full h-auto flex items-center justify-center">
            <div className="w-[90%] flex items-center justify-between my-2 shadow-lg border py-2 rounded-md">
              <div className="ml-5">
                <div className="text-[#40196D] text-[15px] font-bold">
                  Send to Beneficiaries
                </div>
                <div className="text-[12px] text-gray-400">
                  Add to beneficiary to get started.
                </div>
              </div>
              <button className="text-[14px] text-[#40196D] py-1 px-4 rounded-md mr-4 bg-[#DFE3FF]">
                Add
              </button>
            </div>
          </div>
          <div className="w-full h-auto flex items-center justify-center">
            <div
              className="w-[90%] flex items-center justify-between my-2 shadow-lg border py-2 rounded-md hover:cursor-pointer"
              onClick={() => {
                navigate("/auth/send/username");
              }}
            >
              <div className="flex  items-center">
                <div className="ml-4 w-[40px] h-[40px] rounded-md flex items-center justify-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-[12px] text-gray-400">
                    Send to any AJMoney account for free.
                  </div>
                </div>
              </div>
              <div className="mr-4">
          ...
          <div className="w-full h-auto flex items-center justify-center">
            ...
            >
              <div className="flex  items-center">
                <div className="ml-5">
                  <BsFillSendFill className="text-green-600" />
                </div>
                <div className="ml-4">
                  <div className="text-[#40196D] text-[15px] font-bold">
                  ...
                  <div className="text-[12px] text-gray-400">
                    Send to local account for free.
                  </div>
                </div>
              </div>
              <div className="mr-4">
