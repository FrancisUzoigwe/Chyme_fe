  ...
  return (
    <div className="w-[82%] bg-white absolute  right-0 h-[100%] rounded-tl-[30px] md:rounded-tl-none sm:rounded-tl-none rounded-bl-[30px] md:rounded-bl-none sm:rounded-bl-none p-[20px] md:p-0 sm:p-0 sm:w-[100%] md:w-[100%] ">
      ...
      >
        ...
        <div className="w-[50%] max-md:w-[90%] border shadow-md rounded-md py-[50px] flex flex-col items-center">
          <div className="text-[20px] font-bold my-3 text-[#40196D]">
            Feature Coming soon
          </div>
          <div>
            <BsClockFill className="text-[#ffd23f] text-9xl" />
          </div>
        </div>
      </motion.div>
    </div>
