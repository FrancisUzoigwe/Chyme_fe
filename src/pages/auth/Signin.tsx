          ...
          <div className='w-[90%] flex items-center justify-between h-full'>
            <form onSubmit={onHandleSubmit} className='w-[45%]  max-md:w-full h-full flex flex-col items-center rounded-md'>
              <div className='flex justify-between items-center w-full my-2'>
                ...
                <div className='flex items-center text-[13px] font-bold '>Are you new?  <button className="ml-2 border border-[#40196D] outline-none py-2 px-4 rounded-3xl hover:text-white hover:bg-[#40196D] transition duration-300 " onClick={() => {
                  navigate("/register")
              ...
              <button className={`w-[70%] rounded-3xl h-[45px] transition duration-300  ${checked ? "bg-[#40196D] text-white" : "text-gray-500 bg-gray-300"}`} type="submit" disabled={!checked}>Login</button>
